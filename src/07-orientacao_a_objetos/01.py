""" Aula 07.01 – Introdução à Orientação a Objetos """

# paradigma de programacao

# calcular a area e o perimetro de um retangulo
# estrutura para armazenar os valores necessarios para os calculos
# area = base * altura
...
print(calcular_perimetro(retangulo))
print(calcular_perimetro(retangulo2))

# Classe representa um conceito - retangulo
# classe possui atributos
# classe possui metodos - funcoes dentro das classes
