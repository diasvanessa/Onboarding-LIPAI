"""
ex04.py – Lista de participações no Projeto
...
...
○ Requisitos:
■ O método add_participacao deve receber um objeto
Participacao como parâmetro e adicioná-lo à lista
participacoes.
